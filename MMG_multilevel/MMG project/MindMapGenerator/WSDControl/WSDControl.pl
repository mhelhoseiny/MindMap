...
=begin PerlCtrl
    ...
    %TypeLib = (
        PackageName     => 'WSD',
        DocString       => 'Word Sense Disamiguation',
	TypeLibGUID     => '{AEA48CA7-9329-4C2B-B734-A4BBCD7C1AEC}', # do NOT edit this line
	ControlGUID     => '{951A9436-0E18-40BB-8D0C-DBA1310217F0}', # do NOT edit this line either
	DispInterfaceIID=> '{6306ED69-A914-4651-A261-672F82D85179}', # or this one
        ControlName     => 'WSD_Control',
