namespace MapperTool
{
	partial class FrmVerbRelation
	{
		...
		private void InitializeComponent()
		{
			...
			nounFrames.Size = new System.Drawing.Size(64, 13);
			nounFrames.TabIndex = 29;
			nounFrames.Text = "verbFrames";
			// 
			// label1
			// 
			...
			this.cmbverbFrames1.TabIndex = 27;
			// 
			// cmbVerbFrames2
			// 
			...
			this.cmbVerbFrames2.TabIndex = 30;
			// 
			// btnOk
			// 
			...
			this.cmbDomainRelation.TabIndex = 28;
			// 
			// FrmVerbRelation
			// 
			...
			this.Name = "FrmVerbRelation";
			this.Text = "verb relation";
