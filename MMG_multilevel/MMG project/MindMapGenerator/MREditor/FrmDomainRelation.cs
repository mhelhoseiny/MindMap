...
{
	public partial class FrmDomainRelation : Form
	{
		List<VerbFrame> verbs;
		public int VerbIndex1,VerbIndex2;
		public DomainRelationType domainRelation;
		public FrmDomainRelation(List<VerbFrame> verbFrames)
		{
			InitializeComponent();
			//for (int i = 0; i < 3; i++)
		...
		public FrmDomainRelation(List<VerbFrame> verbFrames, int verbIndex1, int verbIndex2)
			: this(verbFrames)
		{
