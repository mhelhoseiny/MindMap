...
namespace mmTMR
{
    ...
    {
        ExpectedResult,
        Completion, //like help do (do is completion)
        UnExpectedResult,
        Reason,
        //new relations:
        Contrast,
        Comparison, //if A and B are in some sense similar
        Condition,
        PossibleResult,
        //newer relations:
        Concessive,// A is not believed to be a result of B (even though)
        Enablement,
        //other......
        How,
        place,
	...
	[Serializable]
    public class VerbFrame: Frame
    {
        bool _passive;
        bool _VerbNegation;//verb is negated
        //MindMapConcept _concept;
        VerbTense _verbTense;

        public VerbTense VerbTense
        {
            get { return _verbTense; }
            set { _verbTense = value; }
        }

        List<MyWordInfo> _adverbsInfo = new List<MyWordInfo>();

        public List<MyWordInfo> AdverbsInfo
        {
            get { return _adverbsInfo; }
            set { _adverbsInfo = value; }
        }
        ...
        public bool VerbNegation
        {
            get { return _VerbNegation; }
            set { _VerbNegation = value; }
        }
        ...
        {
            get { return _transitive; }
            set { _transitive = value; }
        }
        ...
        public List<string> _Adverb;
        public MindMapConcept Predicate;
