...
namespace MyWnlib
{
	...
	public class SemCor
	{
		...
		public SemCor(Lexeme lex, int hereiam)
		{
            ...
            System.IO.StreamReader indexFile = new System.IO.StreamReader(MyWnlib.WNDB.path + @"\index.sense");

			// locate our word and key via a binary search
			string semline = MyWnlib.WNDB.binSearchSemCor(key, lex.word, indexFile);
