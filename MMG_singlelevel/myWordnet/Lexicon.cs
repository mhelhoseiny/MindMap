...
namespace WnLexicon
{
	...
	public class Lexicon
	{
		static Lexicon()
		{
			...
			StreamReader sr = new StreamReader(Wnlib.WNCommon.path+"other.txt");
			while(sr.Peek()!=-1)
			{
			...
			//**************************************************
			Verbs=new Hashtable();
			sr = new StreamReader(Wnlib.WNCommon.path+"src_verb.exc");
			while(sr.Peek()!=-1)
			{
				string l=sr.ReadLine();
				if(l=="")
			...
			Adj=new Hashtable();
			sr = new StreamReader(Wnlib.WNCommon.path+"src_adj.exc");
			while(sr.Peek()!=-1)
			{
				string l=sr.ReadLine();
				if(l=="")
			...
			Noun=new Hashtable();
			sr = new StreamReader(Wnlib.WNCommon.path+"noun.exc");
			while(sr.Peek()!=-1)
			{
				string l=sr.ReadLine();
				if(l=="")
			...
			sr = new StreamReader(Wnlib.WNCommon.path+"names.txt");
			while(sr.Peek()!=-1)
			{
				string l=sr.ReadLine();
				if(l=="")
		...
		private static void InitRuleWords()
		{
            ...
            RuleWords.Add("CAN_NOT", new ArrayList(new string[] { "XV" }));
            ...
            RuleWords.Add("SHALLN'T", new ArrayList(new string[] { "XV" }));
